...
const quoteGenerateBtn = document.querySelector('#load-quote');

// first making function to generate random quote and display it to the HTML
function generateQuote() {

    // First generating random number/quote
    ...
    sourceBox.innerHTML = ` <p class="source">- ${randomQuote.source}</p>`;
}

// Add eventlistener to the button to change the quote
quoteGenerateBtn.addEventListener('click', generateQuote);


// Quote automatically refreshes in eveyr 20 seconds
window.setInterval(() => {
    generateQuote();
},20000);